...
const FormSchemaCostumer = z.object({
  id: z.string(),
  name: z.string().min(5, {message: 'Please enter a name with more than 5 characters'}),
...
const CreateCustomer = FormSchemaCostumer.omit({ id: true});
